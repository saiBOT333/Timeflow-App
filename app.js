        ...
        function openModal(id, options) {
            if (id === 'settingsModal') {
                openSettingsModal(options); // src/settings.js übernimmt Init + classList.add
                return;
            }
        ...
        // PAKET 7: CARD_ID_TITLE_MAP, toggleCardVisibilityMenu, renderCardVisibilityMenu,
        // toggleCardVisibility, applyCardVisibility, toggleCompactMode, applyCompactMode,
        // applyPreset, click-outside listener → src/ui/cardVisibility.js
